...
This system should be made available to the community to show that it can work differently and poverty in the world can be reduced.
...
Due to the high level of automation and no administrative costs\footnote{Except for the Tx fees, these charges may differ depending on the network used, such as Ethereum.}.
