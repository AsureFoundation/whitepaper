...
\paragraph{Perioden} Jede Aktion innerhalb des Rentensystems erfolgt
in einer Periode $P_{n}$. Die Dauer einer Periode ist frei wählbar. Innerhalb der folgenden Betrachtung gilt $P_{n} = 1 month$.
