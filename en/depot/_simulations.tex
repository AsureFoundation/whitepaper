...
User & Periods & Contributions & Result \\ [0.5ex] 
\hline
1..100 & 1..480 & $\sum_{j=0}^{39} 12 \cdot CCV \cdot 1.05^j = 1450$ & 3831 \\ 
100..200 & 480..960 & $\sum_{j=40}^{79} 12 \cdot CCV \cdot 1.05^{j} = 10165$ & 7783 \\ [1ex] 
 \hline
 \end{tabular}%
}
\end{table}
...
User & Periods & Contributions & Result \\ [0.5ex] 
\hline
1..100 & 1..480 & $sum(CCV \cdot 1.05^{n}) = 217$ & 150 \\ 
100..200 & 480..960 & $sum(CCV \cdot 1.05^{40}) = 31$ & 98 \\ [1ex] 
 \hline
 \end{tabular}%
}
\end{table}
